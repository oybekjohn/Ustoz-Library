...
const SYSTEM_PROMPT = [
  ...
  "- MUHIM: o'zbekcha matnda ruscha yoki inglizcha so'zlarni tarjimasiz qoldirmang.",
  "  Masalan \"kachestvo\" emas \"sifat\", \"innovatsiya\" o'rniga kerak bo'lsa \"yangilik\".",
  "  Faqat atoqli otlar (universitet, kompaniya, shaxs nomlari) asl holida qoladi.",
