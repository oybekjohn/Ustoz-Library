-- ============================================================
-- Migration 0006: Production sync
-- Faqat 0005 da yaratilgan jadvallar production D1 ga qo'shiladi.
-- books, telegram_sessions, telegram_admins jadvallariga tegmaydi.
-- SAFE: CREATE TABLE IF NOT EXISTS va ALTER TABLE (agar mavjud bo'lmasa)
-- ============================================================
